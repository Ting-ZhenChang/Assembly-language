...
main:
    jal printID
    jal printLast1 # 印出 "please enter the strokes of the first character of the last name"
    jal input
    mv t0, a0 # t0  = the strokes of the first character of last name
    jal printLast2 # 印出 "please enter the strokes of the second character of last name"
    jal input
    mv t1, a0 # t1 =  the strokes of the second character of last name
    jal printFirst1 # 印出 "please enter the strokes of the first character of first name"
    jal input
    mv t2, a0 # t2 =  the strokes of the first character of first name
    jal printFirst2 # 印出 "please enter the strokes of the second character of first name"
    jal input
    mv t3, a0 # t3  =  the strokes of the second character of first name
